    ...
    <div>
        <div className="min-h-screen flex-col items-center justify-center bg-gray-100" >
            ...
            <div className="flex flex-col items-center justify-center h-screen" >
                <h1 className="text-2xl font-bold mb-8" >Are you sure you want to delete this Account?</h1>

                <div className="flex space-x-4" >
                    <input type='button' value='Yes' onClick={() => handleDelete()} className="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded" />
                    <input type='button' value='No' onClick={() => router.replace('/profile')} className="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded" />
                </div>
            </div>
